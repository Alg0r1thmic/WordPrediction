...
int main()
{
	...
	std::wifstream fin("../learning_words/sets/difficult_words.txt", std::ifstream::in);	
	fin.imbue (loc);

	std::fstream finw("../learning_words/sets/difficult_words_webhits.txt", std::fstream::in);
